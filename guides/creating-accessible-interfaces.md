...
ernatives for video include an audio description track or a document similar to a screenpla(which includes dialog, description of sounds, and description of action).  
